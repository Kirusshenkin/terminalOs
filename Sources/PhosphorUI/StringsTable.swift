...
extension Strings {
    static let table: [String: [Language: String]] = [
        ...
        "term.status.idle": [.russian: "покой", .english: "idle"],
        "term.status.blocked": [.russian: "ждёт", .english: "blocked"],
        ...
        "nav.graphs": [.russian: "графики", .english: "graphs"],
        "mon.waitingHistory": [
            .russian: "жду второй замер: загрузка — это разница между снимками",
            .english: "waiting for a second reading: usage is a difference between snapshots",
        ],
        "mon.cpuLoad": [.russian: "процессор", .english: "cpu"],
        "mon.memorySwap": [.russian: "память и swap", .english: "memory and swap"],
        "mon.network": [.russian: "сеть", .english: "network"],
        "mon.disk": [.russian: "диск", .english: "disk"],
        "mon.in": [.russian: "приём", .english: "in"],
        "mon.out": [.russian: "отдача", .english: "out"],
        "mon.read": [.russian: "чтение", .english: "read"],
        "mon.write": [.russian: "запись", .english: "write"],
