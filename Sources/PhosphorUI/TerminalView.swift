...
public struct TerminalPane: View {
    ...
    public var body: some View {
        ...
        // Раскладка прошлого запуска: тот же спейс, та же сессия. Соединение
        // поднимается здесь, а не на разблокировке окна, — когда на него
        // действительно смотрят.
        .task { await model.resumeLayout() }
