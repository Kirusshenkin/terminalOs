...
struct HostSessionTests {
    ...
    func skipsDockerWhenAbsent() async throws {
        ...
        // Уходят ровно два: профиль хоста и разовый запрос неизменного —
        // модели процессора и версии ядра. Ничего лишнего.
        #expect(executed.count == 2, "лишние команды к хосту без докера")
    }
